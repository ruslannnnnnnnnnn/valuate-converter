...
let calculate = (e) => {
    ...
    if (currency_left_value == currency_right_value) {
        ...
        if(e){
            fetch(` https://v6.exchangerate-api.com/v6/83af0a633e5792569f62fefd/latest/USD=${currency_right_value}&symbols=${currency_left_value}`)
            .then((response) => {
            ...
            fetch(` https://v6.exchangerate-api.com/v6/83af0a633e5792569f62fefd/latest/USD=${currency_left_value}&symbols=${currency_right_value}`)
                .then((response) => {
                    return response.json();
                })
                .then((data) => {
